...
if ( ! class_exists( 'Site_Copier_Post_Types' ) ) {
    class Site_Copier_Post_Types extends Site_Copier {
        ...
        public function copy( $post_id = false ) {
            ...
            $this->log( 'class.copier-post-types. Hole Argumente für Quellbeiträge:' );
            $this->log( $args );
            ...
            foreach ( $all_posts as $post ) {
                ...
                */
                ...
                if ( ! is_wp_error( $new_post_id ) ) {
                    ...
                    $this->log( 'class.copier-post-types. Fehler beim Klonen des Beitrags:' );
                    $this->log( $new_post );
                }
        ...
        public function clear_posts() {
            ...
            $this->log( 'class.copier-post-types.php. Beiträge löschen. Argumente:' );
            $this->log( $args );
