<div class="cloner-clone-option" id="cloner-create-wrap">
	...
	<?php else: ?>
		...
		<input id="blog_create" name="blog_create" class="regular-text" type="text" title="<?php esc_attr_e( 'Domain' ) ?>" placeholder="<?php echo esc_attr( __( 'Gib hier Deinen Webseiten-Namen ein...', PSOURCE_CLONER_LANG_DOMAIN ) ); ?>"/>
	<?php endif; ?>
