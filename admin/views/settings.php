<div class="wrap">
	...
	<?php if ( $updated ): ?>
		<div class="updated"><p><?php _e( 'Einstellungen aktualisiert', PSOURCE_CLONER_LANG_DOMAIN ); ?></p></div>
	<?php endif; ?>

	<h2><?php echo esc_html( get_admin_page_title() ); ?></h2>

	<form method="post" id="cloner-settings-form" action="">
		<h3><?php _e( 'Erste Schritte:', PSOURCE_CLONER_LANG_DOMAIN ); ?></h3>
		<div class="cloner-settings-image-wrap">
			<img src="<?php echo PSOURCE_CLONER_ASSETS_URL . '/images/step_1.jpg'; ?>">
			<p class="description"><?php printf( __( 'Navigiere zu <a href="%s">Netzwerkadministrator &raquo; Webseiten</a>', PSOURCE_CLONER_LANG_DOMAIN ), network_admin_url( 'sites.php' ) ); ?></p>
		</div>
		<div class="cloner-settings-image-wrap">
			<img src="<?php echo PSOURCE_CLONER_ASSETS_URL . '/images/step_2.jpg'; ?>">
			<p class="description"><?php _e( 'Bewege den Mauszeiger über eine Webseite und klicke auf "Klonen".', PSOURCE_CLONER_LANG_DOMAIN ); ?></p>
		</div>
		<div class="clear"></div>
		
		<h3><?php _e( 'Wähle den Inhalt aus, den Du kopieren möchtest:', PSOURCE_CLONER_LANG_DOMAIN ); ?></h3>
		...
		<h3>
			<?php _e( 'Ersetze URLs und Bilder', PSOURCE_CLONER_LANG_DOMAIN ); ?>
		</h3>
		...
		<ul id="cloner-replace-list" class="cloner-list">
			...
			<li>
				<label>
					...
					<?php _e( 'Links ersetzen', PSOURCE_CLONER_LANG_DOMAIN ); ?>
				</label>
			</li>
			...
			<li>
				<label>
					...
					<?php _e( 'Bilder ersetzen', PSOURCE_CLONER_LANG_DOMAIN ); ?>
				</label>
			</li>
